...
class Home:
    '''
    This class represents all the other home page functions
    '''

    def __init__(self, db_path):
        '''
        Constructor Method For Class Home
    ...
    def plot_current_month_daily_spend(self):
        '''
        This method returns current month daily amount spend on 'Home Maintanence' category values 
        to plot line chart

        :return: returns current month daily amount spend on 'Home Maintanence' category values
        :rtype: list
        '''
        ...
        for i in range(1, day+1):
            try:
                cursor.execute(query, (month, i, 'Home Maintanence'))
    ...
    def get_latest_ten_spends(self):
        '''
        This method returns latest 10 amount spent transactions in 'Home Maintanence' category

        :return: returns latest 10 amount spent transactions in 'Home Maintanence' category
        :rtype: list
        '''

        cursor = self.__connection.cursor()
        query = "SELECT * FROM amount_spend as a WHERE a.'S No' > 0 and a.'Category' in ('Home Maintanence') ORDER BY a.'S No' DESC  LIMIT 10;"
        try:
...
if __name__ == "__main__":
    home = Home(db_path="/Users/srinivas/Desktop/M_Monitor/main_monitor.db")
    print(home.plot_current_month_daily_spend())
    print(home.get_latest_ten_spends())
    print(home.db_path)
    print(home.connection)