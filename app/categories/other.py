...
class Other:
    '''
    This class represents all the other category page functions
    '''

    def __init__(self, db_path):
        '''
        Constructor Method For Class Other
    ...
    def plot_current_month_daily_spend(self):
        '''
        This method returns current month daily amount spend on 'others' category values 
        to plot line chart

        :return: returns current month daily amount spend on 'others' category values
        :rtype: list
        '''
        ...
        for i in range(1, day+1):
            try:
                cursor.execute(query, (month, i, 'Others'))
    ...
    def get_latest_ten_spends(self):
        '''
        This method returns latest 10 amount spent transactions in 'others' category

        :return: returns latest 10 amount spent transactions in 'others' category
        :rtype: list
        '''

        cursor = self.__connection.cursor()
        query = "SELECT * FROM amount_spend as a WHERE a.'S No'  > 0 and a.'Category' in ('Others') ORDER BY a.'S No' DESC  LIMIT 10;"
        try:
...
#     other = Other(db_path="/Users/srinivas/Desktop/M_Monitor/main_monitor.db")
#     print(other.plot_current_month_daily_spend())
#     print(other.get_latest_ten_spends())
#     print(other.db_path)
