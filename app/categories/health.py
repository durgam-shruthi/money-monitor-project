...
class Health:
    ...
    def plot_current_month_daily_spend(self):
        ...
        for i in range(1, day+1):
            try:
                cursor.execute(query, (month, i, 'Health Maintenance'))
    ...
    def get_latest_ten_spends(self):
        ...
        cursor = self.__connection.cursor()
        query = "SELECT * FROM amount_spend as a WHERE a.'S No' > 0 and a.'Category' in ('Health Maintenance') ORDER BY a.'S No' DESC  LIMIT 10;"
        try:
...
if __name__ == "__main__":
    health = Health(db_path="/Users/srinivas/Desktop/M_Monitor/main_monitor.db")
    print(health.plot_current_month_daily_spend())
    print(health.get_latest_ten_spends())
    print(health.db_path)
    print(health.connection)